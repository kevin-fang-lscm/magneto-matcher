...
def fine_tune_sentence_transformer(
    ...
    # Use CosineSimilarityLoss instead of ContrastiveLoss
...
def generate_column_name_pairs(data, num_samples=5):
    ...
    for column, column_values in data.items():
        ...
        for value, variations in column_values.items():
            ...
            for variation in all_variations:
                positive_pairs.append((column, variation, 1.0))
    ...
    pairs = positive_pairs + semi_positive_pairs + negative_pairs
...
if __name__ == "__main__":
    ...
    sampled_pairs = random.sample(pairs, min(40000, len(pairs)))
    pairs = sampled_pairs
