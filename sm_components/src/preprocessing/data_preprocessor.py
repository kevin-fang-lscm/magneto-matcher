...
class DataPreprocessor:
    ...
    def clean_data(self):
        ...
        self.df.columns = self.df.columns.str.strip()  # Strip white spaces from column names
    ...
    def normalize_columns(self):
        ...
        """
        self.df.columns = self.df.columns.str.lower()  # Normalize column names to lowercase
        return self  # Return self for method chaining
